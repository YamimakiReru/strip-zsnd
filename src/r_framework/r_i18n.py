from .log import FrameworkLogMixin
...
class I18nConfigurator(FrameworkLogMixin):
    ...
    @classmethod
    def _on_missing_translation(cls, key: str, locale: str, **kwargs: Any):
    ...
    @classmethod
    def _gettext_hook_proc(cls, domain: str, key: str):
        return i18n.t(cls.GETTEXT_KEY_PREFIX + key)

    @classmethod
    def _ngettext_hook_proc(cls, domain: str, msgid1: str, msgid2: str, n: int):
    ...
    def _determine_locale(self, available_locales: Sequence[str]) -> str | None:
        ...
        result = self._is_available_locale(
            os.getenv("LANG"), available_locales
    ...
    def _is_available_locale(
        self, locale_id: str | None, available_locales: Sequence[str]
    ) -> str | None:
        """
